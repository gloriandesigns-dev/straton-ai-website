...
export const About = () => {
  return (
    <div className="flex flex-col gap-10 animate-fade-in">
      ...
      {/* Business Driven Statement Section */}
      <section className="relative bg-[#1A0905] rounded-[20px] border-2 border-brand-orange p-16 md:p-32 flex items-center justify-center overflow-hidden shadow-2xl">
      ...
      {/* How We Work Section */}
      <section className="bg-[#1A0905] rounded-[20px] border-2 border-brand-orange p-12 md:p-16 shadow-2xl">
              ...
              <div className="relative z-10 flex-1 flex flex-col">
                ...
                <ul className="space-y-4 mt-auto">
                  {card.points.map((point, j) => (
                    <li key={j} className="flex items-start gap-3 text-white/90 text-xs leading-relaxed">
        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 items-start">
          ...
          <div className="w-full lg:w-1/2 bg-[#F3F3F3] rounded-[20px] overflow-hidden flex flex-col sm:flex-row">
            ...
            <div className="sm:w-3/5 p-8 md:p-10 flex flex-col justify-center">
              ...
              <div className="space-y-4 text-sm text-[#111111] leading-relaxed">
      ...
      <section className="bg-gradient-to-br from-[#FF4D2E] via-[#ff6b52] to-[#ff8f7a] rounded-[20px] border-2 border-brand-orange p-8 md:p-24 flex justify-center shadow-2xl">
        <div className="bg-white rounded-[12px] max-w-4xl w-full relative p-12 md:p-20 shadow-2xl">
          ...
          <div className="space-y-8 text-lg md:text-xl text-[#111111] font-light leading-relaxed max-w-3xl">
          ...
          <div className="flex flex-col sm:flex-row gap-16 mt-20">
            <div>
          ...
          <div className="w-full lg:w-1/2 bg-[#1A0905] p-10 md:p-16 border-b lg:border-b-0 lg:border-r border-white/10">
            ...
            <ul className="space-y-8">
              {[
                ...
                <li key={i} className="flex items-center gap-4 text-white/70 text-sm md:text-base">
          ...
          <div className="w-full lg:w-1/2 bg-[#6B46C1] p-10 md:p-16 relative overflow-hidden">
            ...
            <ul className="space-y-8 relative z-10">
              {[
                ...
                <li key={i} className="flex items-center gap-4 text-white text-sm md:text-base font-medium">
