...
export const Home = () => {
  return (
    <div className="flex flex-col gap-10 animate-fade-in">
      {/* Hero Section */}
      <section className="relative bg-[#1A0905] rounded-[20px] border-2 border-brand-orange overflow-hidden shadow-2xl min-h-[600px] flex items-center">
      ...
      {/* BFSI Expertise Section */}
      <section className="bg-[#1A0905] rounded-[20px] border-2 border-brand-orange overflow-hidden shadow-2xl flex flex-col lg:flex-row">
      ...
      <section className="bg-[#1A0905] rounded-[20px] border-2 border-brand-orange overflow-hidden shadow-2xl flex flex-col lg:flex-row">
        ...
        <div className="lg:w-1/2 p-8 md:p-12 bg-[#2A0F08] flex flex-col gap-6">
          {[
      ...
      <section className="relative bg-gradient-to-br from-[#FF4D2E] via-[#ff6b52] to-[#ff8f7a] text-white px-12 py-24 md:px-20 md:py-32 overflow-hidden animate-gradient rounded-[20px] border-2 border-brand-orange shadow-2xl">
        ...
        <div className="relative z-10 flex flex-col lg:flex-row gap-16 lg:gap-24 items-start">
          ...
          <div className="flex-1 flex flex-col gap-10 text-2xl md:text-3xl font-light tracking-wide max-w-xl relative">
      ...
      <section className="bg-[#1A0905] text-white p-12 md:p-20 rounded-[20px] border-2 border-brand-orange shadow-2xl">
      ...
      {/* The Straton Way Section */}
      <section className="bg-[#F3F3F3] text-[#111111] p-12 md:p-20 rounded-[20px] border-2 border-brand-orange shadow-2xl">
        <div className="mb-16 flex flex-col lg:flex-row justify-between items-start lg:items-end gap-10">
      ...
      {/* AI Value Statement Section */}
      <section className="relative bg-[#1A0905] py-32 px-12 md:px-20 flex items-center justify-center overflow-hidden rounded-[20px] border-2 border-brand-orange shadow-2xl">
        <div className="absolute inset-0 bg-dotted-grid opacity-20"></div>
